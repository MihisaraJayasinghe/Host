...
exports.signUp = async (req, res) => {
    try {
        ...
        const user = await User.create({ username, password: hashedPassword, role ,Faculty});
...
exports.logIn = async (req, res) => {
    try {
        ...
        const token = jwt.sign({ role: user.role , Faculty: user.Faculty }, process.env.JWT_SECRET);
